...
class Server:
    def __init__(self):
        ...
        self._app.add_url_rule("/<classifier_name>/test", "test", self._test, methods=["GET"])
    ...
    def _test(self, classifier_name: str):
        return 'Hello World!', classifier_name
    ...
    def _predict(self, classifier_name: str):
        result = HTTPStatus.NO_CONTENT.description
